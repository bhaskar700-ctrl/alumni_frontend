        ...
        <div className="xl:w-2/5 lg:w-2/5 bg-indigo-700 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
          <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
            ...
            <div className="flex pb-4 items-center">
              ...
              <p className="pl-4 text-white text-base">+ 9876543210</p>
            </div>
            <div className="flex items-center">
              ...
              <p className="pl-4 text-white text-base">tezpur university.com</p>
            </div>
            ...
            <div className="pt-16">
              <a href="javascript:void(0)" className="text-white font-bold tracking-wide underline focus:outline-none focus:ring-2 focus:ring-white ">
              </a>
            </div>
          </div>
        </div>
